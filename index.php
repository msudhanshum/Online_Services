...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/homebg.jpg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-white font-weight-bold">Welcome to OSMS</h1>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        OSMS Pvt Ltd, <br>
        Koraon Prayagraj <br>
        Uttar Pradesh - 212106 <br>
        Phone: +91 6306629632 <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Sudhanshu &copy; 2021.
          </small>
